...
cortex_demo_pages = [
    st.Page("text_app.py", title="ai_complete Text example", icon=":material/description:"),
    st.Page("text_minimal_app.py", title="ai_complete Text (minimal) example", icon=":material/notes:"),
]
